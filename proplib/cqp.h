/*
* CoolQ definations and structs
* Api Version 9
* Written by Coxxs & Thanks for the help of orzFly
* Modified from original header cqp.h, however the original header is C++ header ,should be named as cqp.hpp,
* this version header is header for C
*/
#pragma once
...
#ifndef CQAPI
#define CQAPI(ReturnType) _EXTERNC __declspec(dllimport) ReturnType __stdcall
#endif

#define CQEVENT(ReturnType, Name, Size) __pragma(comment(linker, "/EXPORT:" #Name "=_" #Name "@" #Size))\
 _EXTERNC __declspec(dllexport) ReturnType __stdcall Name
